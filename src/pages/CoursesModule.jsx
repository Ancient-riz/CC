...
import { ugPrograms } from '../data/ugData';
...
const CoursesModule = () => {
  ...
  const allPrograms = Object.values(ugPrograms).flatMap(stream =>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          <h2 className="text-4xl font-bold text-white mb-4">
            Degree <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">Explorer</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Explore comprehensive undergraduate degree programs across all streams. 
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search degrees and specializations..."
                  value={searchTerm}
        ...
        <div className="mb-6">
          <p className="text-gray-300">
            Showing {filteredPrograms.length} degree program{filteredPrograms.length !== 1 ? 's' : ''}
        ...
        {filteredPrograms.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">No degree programs found</h3>
        ...
        <div className="mt-12 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-lg p-8 border border-blue-500/20">
          <h3 className="text-2xl font-bold text-white mb-6 text-center">
            🎓 Degree Programs by Stream
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {Object.values(ugPrograms).map((stream) => (
